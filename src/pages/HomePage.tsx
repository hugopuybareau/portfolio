...
import QRTLogo from '/assets/icons/qrtLogo.png';
    ...
    return (
        ...
        >
            ...
            <ul className="grid gap-1 text-base">
                        ...
                        label: (
                            <>
                                ...
                                <span className="inline-flex items-center gap-1">
                                    ...
                                    <a
                                        className="relative left-[4px] top-[3px]"
                                    >
                                        (4th/800)
                                    </a>
                                </span>{' '}
                ...
                <li className="group flex items-start gap-4 pl-4 pt-4 relative hover:translate-x-1 transition-transform duration-200">
                    <span>
                        ...
                        <span className="inline-flex items-center gap-1">
                            ...
                            <span className="text-gray-400 relative top-[3px] left-[4px]">(Mar 2025 – Present)</span>
                        </span>
                    </span>
                </li>
                <li className="ml-8 text-gray-400 hover:translate-x-1 transition-transform duration-200">
                    • built an LLM-powered SaaS with Azure OpenAI + LangChain</li>
                <li className="ml-8 text-gray-400 hover:translate-x-1 transition-transform duration-200">
                ...
                <li className="ml-8 text-gray-400 hover:translate-x-1 transition-transform duration-200">
                    • built ML models (XGBoost, KNN, Random Forest) on open data</li>
                <li className="ml-8 text-gray-400 hover:translate-x-1 transition-transform duration-200">
                    • delivered dashboards for non-technical business stakeholders</li>
            ...
            >
                ...
                <a
                    href="assets/resume_PUYBAREAU.pdf"
            ...
            >
                ...
                <div className="mt-2 sm:mt-0 flex gap-4">
                    {[
                        { label: 'GitHub', href: 'https://github.com/hugopuybareau' },
                        { label: 'LinkedIn', href: 'https://www.linkedin.com/in/hugopuybareau/' },
                        { label: 'Email', href: 'mailto:hugo.puybareau@etu.ec-lyon.fr' },
                    ].map(({ label, href }) => (
                        <a
                            key={label}
                            href={href}
